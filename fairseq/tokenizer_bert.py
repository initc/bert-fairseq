...
class BertTokenizer(object):
    ...
    def binarize(self, input_file, consumer):
        with open(input_file, "r") as f:
            for line in f:
                tokens = self.tokenize(" ".join(whitespace_tokenize_(line.strip())))
                consumer(self.convert_tokens_to_ids(tokens))

    def convert_text_to_ids(self, text):
        tokens = self.tokenize(" ".join(whitespace_tokenize_(text.strip())))
    ...
    @classmethod
    def build_tokenizer(cls, vocab_file, do_lower_case=True):
        try:
